...
import com.example.mohammed.movieapp.adapter.ReviewAdapter;
import com.example.mohammed.movieapp.adapter.TrailerAdapter;
import com.example.mohammed.movieapp.data.MovieContract;
import com.example.mohammed.movieapp.model.Movie;
import com.example.mohammed.movieapp.model.Review;
...
public class DetailedActivityFragment extends Fragment {
    ...
    public static final String TAG = DetailedActivityFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDetailLayout = (ScrollView) rootView.findViewById(R.id.detailed_layout_fr);
        ...
        mTitleView = (TextView) rootView.findViewById(R.id.detailed_title);
        mOverviewView = (TextView) rootView.findViewById(R.id.detailed_overview);
        mDateView = (TextView) rootView.findViewById(R.id.detailed_date);
        mVoteAverageView = (TextView) rootView.findViewById(R.id.detailed_vote_average);

        mTrailersView = (LinearListView) rootView.findViewById(R.id.detailed_trailers);
        mReviewsView = (LinearListView) rootView.findViewById(R.id.detailed_reviews);
        ...
        if (mMovie != null) {
            ...
            String image_url = Utility.buildImageUrl(342, mMovie.getImage_detailed_path());
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mMovie != null) {
            inflater.inflate(R.menu.menu_fragment_detailed, menu);
                            ...
                            // if it is not in favorites
                                ...
                                new AsyncTask<Void, Void, Uri>() {
                                    ...
                                    protected Uri doInBackground(Void... params) {
                                        ...
                                        values.put(MovieContract.MovieEntry.COLUMN_IMAGE_PATH, mMovie.getImage_path());
                                        values.put(MovieContract.MovieEntry.COLUMN_IMAGE_DETAILED_PATH, mMovie.getImage_detailed_path());
    ...
    public class FetchReviewsTask extends AsyncTask<String, Void, List<Review>> {
        ...
        protected List<Review> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        .appendQueryParameter(API_KEY_PARAM, "8491f64c07fc4e57da60705dc84a634b")
                        .build();
